...
import { CrossSectionComparisonTab } from './CrossSectionComparisonTab';
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="mb-6 flex-wrap h-auto gap-2">
          ...
          <TabsTrigger value="ai-insights" className="flex items-center gap-2 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border-primary/20">
          ...
          <TabsTrigger value="cross-section" className="flex items-center gap-2">
            <GitCompare size={16} />
            Section Comparison
          </TabsTrigger>
        ...
        <TabsContent value="cross-section" className="space-y-6">
          <CrossSectionComparisonTab />
        </TabsContent>
